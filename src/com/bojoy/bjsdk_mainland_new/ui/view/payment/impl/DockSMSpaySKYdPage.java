...
public class DockSMSpaySKYdPage extends DockSmsBasePage implements OnClickListener{
	
	private final String TAG = DockSMSpaySKYdPage.class.getSimpleName();
	...
	public DockSMSpaySKYdPage(Context context,DockSMSpaySKBasePage dockSMSpaySKBasePage) {
		super(context, Resource.layout.bjmgf_sdk_dock_recharge_sms_sk_yd_page);
	...
	public void onClick(View v) {
		if(v.equals(payTextView_6)||v.equals(payTextView_8) || v.equals(payTextView_10)){
