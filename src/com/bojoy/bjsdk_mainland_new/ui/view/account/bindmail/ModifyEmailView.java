 ...
 * 修改绑定邮箱 视图
 */
public class ModifyEmailView extends BaseActivityPage implements IBaseView {

    private final String TAG = ModifyEmailView.class.getSimpleName();
    private TextView mTvShow;

    public ModifyEmailView(Context context, PageManager manager,
    ...
    public void setView() {
        ...
        mTvShow.setText(SpUtil.getStringValue(context,"bindEmail",""));
    }
