...
public class CustomerServiceView extends BaseActivityPage implements ICustomerView {
    ...
    private void onTabChanged(int index) {
        ...
        mSendQuestionTextView.setTextColor(context.getResources().getColor(
                ReflectResourceId.getColorId(context, Resource.color.bjmgf_sdk_textgray)));
        mCommonQuestionTextView.setTextColor(context.getResources().getColor(
                ReflectResourceId.getColorId(context, Resource.color.bjmgf_sdk_textgray)));
        mMyQuestionTextView.setTextColor(context.getResources().getColor(
                ReflectResourceId.getColorId(context, Resource.color.bjmgf_sdk_textgray)));
        ...
        switch (index) {
            case TAB_COMMON_QUESTION:
                ...
                mCommonQuestionTextView.setTextColor(context.getResources().getColor(
                        ReflectResourceId.getColorId(context, Resource.color.bjmgf_sdk_question_font_line)));
