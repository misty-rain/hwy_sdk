 ...
 *******************************************************************************/
package com.bojoy.bjsdk_mainland_new.support.imageloader.core;

import com.bojoy.bjsdk_mainland_new.support.imageloader.cache.disc.DiskCache;
import com.bojoy.bjsdk_mainland_new.support.imageloader.cache.memory.MemoryCache;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.assist.ImageSize;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.assist.LoadedFrom;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.assist.ViewScaleType;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.imageaware.ImageAware;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.imageaware.ImageViewAware;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.imageaware.NonViewAware;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.listener.ImageLoadingListener;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.listener.ImageLoadingProgressListener;
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.listener.SimpleImageLoadingListener;
import com.bojoy.bjsdk_mainland_new.support.imageloader.utils.ImageSizeUtils;
import com.bojoy.bjsdk_mainland_new.support.imageloader.utils.L;
import com.bojoy.bjsdk_mainland_new.support.imageloader.utils.MemoryCacheUtils;
...
public class ImageLoader {
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
							 ImageLoadingListener listener, ImageLoadingProgressListener progressListener, boolean needReDownload) {
		checkConfiguration();
		if (imageAware == null) {
		...
		if (TextUtils.isEmpty(uri)) {
			...
			if (options.shouldShowImageForEmptyUri()) {
				if (options.getRoundDisplayer() != null) {
					imageAware.setImageDrawable(options.getImageForEmptyUri(configuration.resources));
				} else {
					imageAware.setBackgroudDrawable(
							ImageUtil.drawableToBitmap(options.getImageForEmptyUri(configuration.resources)));
				}
			} else {
				if (options.getRoundDisplayer() != null) {
					imageAware.setImageDrawable(null);
				} else {
					imageAware.setBackgroudDrawable(null);
				}
			}
		...
		if (bmp != null && !bmp.isRecycled() && !needReDownload) {
			...
			if (options.shouldPostProcess()) {
				...
				if (options.getRoundDisplayer() != null) {
					options.getRoundDisplayer().display(bmp, imageAware, LoadedFrom.MEMORY_CACHE);
				} else {
			...
			if (options.shouldShowImageOnLoading()) {
				if (options.getRoundDisplayer() != null) {
					...
					imageAware.setBackgroudDrawable(
							ImageUtil.drawableToBitmap(options.getImageOnLoading(configuration.resources)));
				}
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,
			ImageLoadingListener listener, boolean needReDownload) {
		displayImage(uri, imageView, options, listener, null, needReDownload);
	}
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener, boolean needReDownload) {
		displayImage(uri, new ImageViewAware(imageView), options, listener, progressListener, needReDownload);
	}
