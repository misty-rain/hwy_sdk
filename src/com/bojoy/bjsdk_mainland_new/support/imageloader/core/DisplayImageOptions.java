...
import com.bojoy.bjsdk_mainland_new.support.imageloader.core.assist.ImageScaleType;
...
public final class DisplayImageOptions {
	...
	private final RoundedBitmapDisplayer roundDisplayer;
	...
	private DisplayImageOptions(Builder builder) {
		...
		roundDisplayer = builder.roundDisplayer;
	...
	public RoundedBitmapDisplayer getRoundDisplayer() {
		return roundDisplayer;
	}
	...
	public static class Builder {
		...
		private RoundedBitmapDisplayer roundDisplayer = null;
		...
		public Builder(int roundRect) {
			decodingOptions.inPurgeable = true;
			decodingOptions.inInputShareable = true;
			roundDisplayer = DefaultConfigurationFactory.createRoundedBitmapDisplayer(roundRect);
		}
		...
		public Builder displayer(RoundedBitmapDisplayer displayer) {
			if (displayer == null) throw new IllegalArgumentException("displayer can't be null");
			this.roundDisplayer = displayer;
			return this;
		}
		...
		public Builder cloneFrom(DisplayImageOptions options) {
			...
			roundDisplayer = options.roundDisplayer;
