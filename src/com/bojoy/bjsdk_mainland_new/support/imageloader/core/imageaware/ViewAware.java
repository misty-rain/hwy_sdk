...
public abstract class ViewAware implements ImageAware {
	...
	@Override
	public boolean setBackgroudDrawable(Bitmap bitmap) {
		if (Looper.myLooper() == Looper.getMainLooper()) {
			View view = viewRef.get();
			if (view != null) {
				setBackgroundDrawableInto(bitmap, view);
				return true;
			}
		} else {
			L.w(WARN_CANT_SET_DRAWABLE);
	 ...
	 * This method is called on UI thread.
	 */
	protected abstract void setBackgroundDrawableInto(Bitmap bitmap, View view);
