 ...
 *******************************************************************************/
package com.bojoy.bjsdk_mainland_new.support.imageloader.core.imageaware;
...
public class ImageViewAware extends ViewAware {
	...
	@Override
	protected void setBackgroundDrawableInto(Bitmap bitmap, View view) {
	    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
			((ImageView) view).setBackground(new BitmapDrawable(view.getContext().getResources(), bitmap));
	    } else {
			((ImageView) view).setBackgroundDrawable(new BitmapDrawable(view.getContext().getResources(), bitmap));
	    }
//		if (drawable instanceof AnimationDrawable) {
//			((AnimationDrawable)drawable).start();
//		}
