...
public class ExitDialog extends Dialog {
	...
	private static final String TAG = ExitDialog.class.getCanonicalName();
...
//		mDialogLayout = (RelativeLayout)View.inflate(context, ReflectResourceId.getLayoutId(getContext(),
//				Resource.layout.bjmgf_sdk_real_dialog), null);
//		mTitleTextView = (TextView)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
//				Resource.id.bjmgf_sdk_dialog_title));
//		mMessageTextView = (TextView)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
//				Resource.id.bjmgf_sdk_dialog_content));
//		mPositiveBtnLayout = (RelativeLayout)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
//				Resource.id.bjmgf_sdk_dialog_positive_btn_layout));
//		mNegativeBtnLayout = (RelativeLayout)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
//				Resource.id.bjmgf_sdk_dialog_negative_btn_layout));
//		mPositiveButton = (Button)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
//				Resource.id.bjmgf_sdk_dialog_positive_btn));
//		mNegativeButton = (Button)mDialogLayout.findViewById(ReflectResourceId.getViewId(getContext(),
